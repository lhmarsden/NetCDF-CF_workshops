...
A NetCDF file has dimensions that define the shape of the data. In this case, our only dimension is the sample depth, and we have 10 depths. 'depth' is a commonly defined dimension name, so to be CF-compliant, we should use that.
